...
% %==========================================================================
% tic
% [IoutDCT,output,Coefs] = denoiseImageDCT(IMin, sigma, K);
% 
...
% figure;
% I = displayDictionaryElementsAsImage(output.D, floor(sqrt(K)), floor(size(output.D,2)/floor(sqrt(K))),bb,bb,0);%当不输入0时，效果不一样，具体的看内部代码
