...
y1=relatively_warp(I1,If);
y2=relatively_warp(I2,If);
y=max(y1,y2);
fprintf('\n\n   I分量的relatively_warp为:  :%.4f\n'  ,y);

y=space_frequency(If);
fprintf('\n\n   I分量的space_frequency为:  :%.4f\n'  ,y);

y=stand_deviation(If);
...
%PSNR Summary of this function goes here 两个参数
