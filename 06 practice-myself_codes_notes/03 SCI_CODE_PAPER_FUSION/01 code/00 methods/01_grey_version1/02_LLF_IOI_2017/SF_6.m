...
for i=1:row
    for j=1:column
        temp(i,j)=( 1/8*(matrix_en(i+1,j+1)-matrix_en(i+1,j))^2 + 1/8*(matrix_en(i+1,j+1)-matrix_en(i,j))^2 + 1/8*(matrix_en(i+1,j+1)-matrix_en(i,j+1))^2 + 1/8*(matrix_en(i+1,j+1)-matrix_en(i,j+2))^2 +...
            1/8*(matrix_en(i+1,j+1)-matrix_en(i+1,j+2))^2 + 1/8*(matrix_en(i+1,j+1)-matrix_en(i+2,j+2))^2 + 1/8*(matrix_en(i+1,j+1)-matrix_en(i+2,j+1))^2 + 1/8*(matrix_en(i+1,j+1)-matrix_en(i+2,j))^2 );
    end
end
for i=1:row
    for j=1:column
