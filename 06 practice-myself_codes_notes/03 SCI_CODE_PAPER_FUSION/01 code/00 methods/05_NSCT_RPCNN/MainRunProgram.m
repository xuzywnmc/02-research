...
filename1 = '.\sourceimages\clock\clock1.tif';
filename2 = '.\sourceimages\clock\clock2.tif';
...
figure('name','Source Image 1'), imshow(imA)
figure('name','Source Image 2'), imshow(imB)
figure('name','Fused Image'), imshow(imF)
imwrite(imF,'.\result\result.tif')
